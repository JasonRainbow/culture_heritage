<template>
  <div class="parent_div">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="apply-form">
        <h2 style="text-align: center;margin:10px auto;color: #303133;font-weight: bold">活动宣传申请</h2>
      ...
      <el-form-item label="宣传网址" prop="activityUrl">
        <el-input v-model="ruleForm.activityUrl"></el-input>
      </el-form-item>
      <el-form-item label="活动简介" prop="desc">
        <el-input type="textarea" v-model="ruleForm.desc"></el-input>
      </el-form-item>
      <el-form-item style="margin-left: 155px">
